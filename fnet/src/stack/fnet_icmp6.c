...
*     Function Prototypes
*************************************************************************/
static void fnet_icmp6_output( fnet_netif_t *netif, fnet_ip6_addr_t *src_ip, fnet_ip6_addr_t *dest_ip, fnet_netbuf_t *nb );
    	...
    	*************************************************************/
    	switch (hdr->type) 
    	{
            ...
            case FNET_ICMP6_TYPE_ECHO_REQ:
                ...
                fnet_icmp6_output(netif, dest_ip/*ipsrc*/, src_ip/*ipdest*/, nb);  
...
*************************************************************************/
static void fnet_icmp6_output( fnet_netif_t *netif, fnet_ip6_addr_t *src_ip, 
                                fnet_ip6_addr_t *dest_ip, fnet_netbuf_t *nb )
{
    ...
    fnet_ip6_output( netif, src_ip, dest_ip, FNET_IP_PROTOCOL_ICMP6, 0, nb, &hdr->checksum);
}
...
*************************************************************************/
void fnet_icmp6_error( fnet_netif_t *netif, unsigned char type, 
                        unsigned char code, unsigned long param, fnet_netbuf_t *origin_nb )
{
    ...
    if(origin_nb)
    {
        ...
        fnet_icmp6_output( netif, dest_ip/*ipsrc*/, src_ip/*ipdest*/, origin_nb);        
